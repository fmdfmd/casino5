				...
				<main className={styles.mainContent}>
					...
					<section className={styles.formContainer}>
						...
						<p className={styles.subtitle}>
							Are you interested in becoming a Stake affiliate? Fill out the
							form below so we can see if you can be a strong partner.
						</p>
						...
						<form className={styles.partnerForm}>
							...
							<div className={styles.gridRow}>
								...
								<div className={styles.formField}>
									<label>
										Traffic Source URL / Channel Name <span>*</span>
									</label>
							...
							<div className={styles.formField}>
								<label>
									Tell us why you would make a great partner <span>*</span>
								</label>
