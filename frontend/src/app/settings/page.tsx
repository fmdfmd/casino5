							...
							<div className={styles.cardBody}>
								<ToggleItem
									...
									onInfoClick={() =>
										openInfo(
											'Stealth Mode',
											'Your username will not be displayed in the public betting log and in the bet preview.',
										)
									}
								/>
								<ToggleItem
									...
									onInfoClick={() =>
										openInfo(
											'Statistics',
											'Only you will be able to see your profit, loss, and total game turnover statistics.',
										)
									}
								/>
								<ToggleItem
									...
									onInfoClick={() =>
										openInfo(
											'Tournaments',
											'Other users will not be able to see your current score or rank in any active tournaments.',
										)
									}
								/>
							</div>
							...
							<div className={styles.cardBody}>
								<ToggleItem
									...
									onInfoClick={() =>
										openInfo(
											'Chat Rains',
											'By enabling this, you will be excluded from receiving random cryptocurrency drops (Rains) in the public chat.',
										)
									}
								/>
							</div>
							...
							<div className={styles.cardBody}>
								<ToggleItem
									...
									onInfoClick={() =>
										openInfo(
											'Email Marketing',
											'Stay updated with personal bonus offers, weekly newsletters, and exclusive event invites.',
										)
									}
								/>
							</div>
